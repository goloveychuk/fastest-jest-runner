...
const FRAMEWORK_INITIALIZER = path.join(
  require.resolve('jest-circus/package.json'),
  '../build/legacy-code-todo-rewrite',
  './jestAdapterInit.js',
);
...
const jestAdapter = async (
  ...
  const { initialize, runAndTransformResultsToJestFormat } =
    runtime.requireInternalModule<any>(FRAMEWORK_INITIALIZER);

  const incorrectTestPath = 'incorrectTestPath.incorrect';
